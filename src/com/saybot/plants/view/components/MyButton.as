...
package com.saybot.plants.view.components
{
	 ...
	 */ 
	public class MyButton extends DisplayObjectContainer
	{
		...
		private var mCanUp:Boolean;
		
		/** Creates a button with textures for up- and down-state or text. */
		public function MyButton(upState:Texture, text:String="", downState:Texture=null)
		{
		...
		public function setDown(canUp:Boolean=true):void {
